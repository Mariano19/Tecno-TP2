...
void draw(){
  ...
  //pacino
  fill(255,255,255,EfectoCreditos+750);
  textSize(19);
  ...
  //sonny
  fill(255,255,255,EfectoCreditos+1150);
  textSize(19);
  ...
  //final
  fill(255,255,255,EfectoCreditos+1550);
  textSize(22);
  text("THE END",width/1.4,posText-3090);
  ...
  println(colorTextoTitulo1);
  println(posSangre);
  println(EfectoCreditos);
}
